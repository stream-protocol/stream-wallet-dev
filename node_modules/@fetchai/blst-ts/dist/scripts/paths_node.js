...
exports.NotNodeJsError = exports.getBinaryPath = exports.getBinaryName = exports.findBindingsFile = exports.ensureDirFromFilepath = exports.mkdirBinary = void 0;
const path_1 = __importDefault(require("path"));
const fs_1 = __importDefault(require("fs"));
const paths_1 = require("./paths");
const BLST_NODE = "blst.node";
function mkdirBinary() {
    if (!fs_1.default.existsSync(paths_1.PREBUILD_DIR)) {
        fs_1.default.mkdirSync(paths_1.PREBUILD_DIR);
    }
}
...
function getBinaryPath() {
    return path_1.default.join(paths_1.PREBUILD_DIR, getBinaryName());
}
...
//# sourceMappingURL=paths_node.js.map