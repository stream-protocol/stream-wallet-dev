...
const paths_node_1 = require("./paths_node");
...
async function buildBindings(binaryPath) {
    ...
    // depending on the OS.
    const bindingsFileOutput = paths_node_1.findBindingsFile(paths_1.BINDINGS_DIR);
    // Copy built .node file to expected path
    paths_node_1.ensureDirFromFilepath(binaryPath);
