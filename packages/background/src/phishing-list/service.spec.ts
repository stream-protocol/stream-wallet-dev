...
const phishings = [
  "stream-wallet-vvallet-app.online",
  "xn--kplr-vva.com",
  "stream-wallet-vvallet.tech",
  "app-stream-wallet-vvallet.online",
  "stream-wallet-vvallet-app.space",
  "stream-wallet-vvallet-app.host",
  "app-stream-wallet-vvallet.tech",
  "app-stream-wallet-vvallet.host",
];
