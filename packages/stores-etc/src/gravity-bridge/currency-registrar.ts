...
import { DenomHelper, KVStore } from "@stream-wallet/common";
import { StreamETCQueries } from "../queries";
...
> {
  constructor(
    ...
    protected readonly queriesStore: IQueriesStore<StreamETCQueries>
  ) {}
  ...
  registerUnknownCurrencies(
    ...
    const erc20Metadata = queries.stream-walletETC.queryERC20Metadata.get(
      contractAddress
    );
