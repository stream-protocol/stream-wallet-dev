...
export abstract class ObservableQueryBase<T = unknown, E = unknown> {
   ...
   *
   * This is a temporarily added feature to implement custom rpc/lcd feature in stream-wallet extension or mobile.
   ...
   *      Unless it's a stream-wallet extension or mobile, you don't need to care about this field.
  ...
  *fetch(): Generator<unknown, any, any> {
    ...
    try {
      ...
      if (
        ...
        // https://github.com/stream-protocol/stream-wallet/issues/275
        // https://github.com/stream-protocol/stream-wallet/issues/278
        // https://github.com/stream-protocol/stream-wallet/issues/318
