...
import { escapeHTML } from "@stream-wallet/common";
import { StdFee } from "@stream-wallet/types";
  ...
  get signDocWrapper(): SignDocWrapper | undefined {
    ...
    if (this._signDocWrapper.mode === "amino") {
      ...
      const signDoc = {
        ...
        //      Currently, there is no support for fee delegation within stream-wallet,
