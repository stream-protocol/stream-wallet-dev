...
const altResolve = () => {
    const p = path.resolve(__dirname, "./src/stream-wallet-torus-signin/index.ts");
        ...
        return {
            alias: {
                "alt-sign-in": path.resolve(
                    __dirname,
                    "./src/stream-wallet-torus-signin/index.ts"
                ),
            },
        };
    }
    ...
    return {
        ...
        plugins: [
            ...
            new webpack.EnvironmentPlugin([
                "NODE_ENV",
                "STREAM_WALLET_EXT_ETHEREUM_ENDPOINT",
                "STREAM_WALLET_EXT_AMPLITUDE_API_KEY",
            ]),
