...
import { Msg } from "@stream-wallet/types";
...
import { AnyWithUnpacked } from "@stream-wallet/cosmos";
import { CoinPretty } from "@stream-wallet/unit";
          ...
          <React.Fragment>
            ...
            </div>
            {
              /*
                ...
                However, if the interaction is internal, you can be sure that the fee is set well inside Stream.
