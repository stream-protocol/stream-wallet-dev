import { WEBPAGE_PORT, Message, BACKGROUND_PORT } from "@stream-wallet/router";
import {
  ContentScriptEnv,
  ContentScriptGuards,
  ExtensionRouter,
...
import { Stream, InjectedStream } from "@stream-wallet/provider";
import { initEvents } from "./events";

import manifest from "../manifest.json";

InjectedStream.startProxy(
  new Stream(manifest.version, "core", new InExtensionMessageRequester())
);
...
@${id} is detected as Stream’s phishing account.
