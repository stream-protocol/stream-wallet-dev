...
import { RegisterOption } from "@stream-wallet/hooks";
import {
  IntlMessages,
...
export const EthereumEndpoint =
  process.env["STREAM_WALLET_EXT_ETHEREUM_ENDPOINT"] || "";
...
export const AmplitudeApiKey = process.env["STREAM_WALLET_EXT_AMPLITUDE_API_KEY"] || "";
